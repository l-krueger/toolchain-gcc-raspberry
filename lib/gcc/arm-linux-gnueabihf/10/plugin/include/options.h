...
enum opt_code
{
  ...
  OPT_Wpedantic_param_names = 616,           /* -Wpedantic-param-names */
  ...
  OPT_Wverbose_unbounded = 736,              /* -Wverbose-unbounded */
  ...
  OPT_fauto_init = 831,                      /* -fauto-init */
  OPT_fauto_profile = 832,                   /* -fauto-profile */
  OPT_fauto_profile_ = 833,                  /* -fauto-profile= */
  OPT_fautomatic = 834,                      /* -fautomatic */
  OPT_fbackslash = 835,                      /* -fbackslash */
  OPT_fbacktrace = 836,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 837,             /* -fblas-matmul-limit= */
  OPT_fbounds = 838,                         /* -fbounds */
  OPT_fbounds_check = 839,                   /* -fbounds-check */
  OPT_fbounds_check_ = 840,                  /* -fbounds-check= */
  OPT_fbranch_count_reg = 841,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 842,           /* -fbranch-probabilities */
  /* OPT_fbranch_target_load_optimize = 843, *//* -fbranch-target-load-optimize */
  /* OPT_fbranch_target_load_optimize2 = 844, *//* -fbranch-target-load-optimize2 */
  /* OPT_fbtr_bb_exclusive = 845, */         /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 846,                /* -fbuilding-libgcc */
  OPT_fbuilding_libphobos_tests = 847,       /* -fbuilding-libphobos-tests */
  OPT_fbuiltin = 848,                        /* -fbuiltin */
  OPT_fbuiltin_ = 849,                       /* -fbuiltin- */
  OPT_fbuiltin_printf = 850,                 /* -fbuiltin-printf */
  OPT_fc_prototypes = 851,                   /* -fc-prototypes */
  OPT_fc_prototypes_external = 852,          /* -fc-prototypes-external */
  OPT_fcall_saved_ = 853,                    /* -fcall-saved- */
  OPT_fcall_used_ = 854,                     /* -fcall-used- */
  OPT_fcaller_saves = 855,                   /* -fcaller-saves */
  OPT_fcallgraph_info = 856,                 /* -fcallgraph-info */
  OPT_fcallgraph_info_ = 857,                /* -fcallgraph-info= */
  OPT_fcanonical_system_headers = 858,       /* -fcanonical-system-headers */
  OPT_fcase = 859,                           /* -fcase */
  /* OPT_fcf_protection = 860, */            /* -fcf-protection */
  OPT_fcf_protection_ = 861,                 /* -fcf-protection= */
  OPT_fchar8_t = 862,                        /* -fchar8_t */
  OPT_fcheck_array_temporaries = 863,        /* -fcheck-array-temporaries */
  /* OPT_fcheck_data_deps = 864, */          /* -fcheck-data-deps */
  OPT_fcheck_new = 865,                      /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 866,           /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 867,                         /* -fcheck= */
  OPT_fchecking = 868,                       /* -fchecking */
  OPT_fchecking_ = 869,                      /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 870,     /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 871,                /* -fchkp-check-read */
  OPT_fchkp_check_write = 872,               /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 873,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 874,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 875,          /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 876,    /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 877,             /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 878, /* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 879,                  /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 880,              /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 881,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 882, /* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 883,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 884,         /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 885,   /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 886,              /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 887,/* -fchkp-zero-input-bounds-for-main */
  /* OPT_fcilkplus = 888, */                 /* -fcilkplus */
  OPT_fcoarray_ = 889,                       /* -fcoarray= */
  OPT_fcode_hoisting = 890,                  /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 891,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 892,                         /* -fcommon */
  OPT_fcompare_debug = 893,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 894,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 895,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 896,                   /* -fcompare-elim */
  OPT_fconcepts = 897,                       /* -fconcepts */
  OPT_fconcepts_diagnostics_depth_ = 898,    /* -fconcepts-diagnostics-depth= */
  OPT_fconcepts_ts = 899,                    /* -fconcepts-ts */
  OPT_fcond_mismatch = 900,                  /* -fcond-mismatch */
  /* OPT_fconserve_space = 901, */           /* -fconserve-space */
  OPT_fconserve_stack = 902,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 903,         /* -fconstant-string-class= */
  OPT_fconstexpr_cache_depth_ = 904,         /* -fconstexpr-cache-depth= */
  OPT_fconstexpr_depth_ = 905,               /* -fconstexpr-depth= */
  OPT_fconstexpr_loop_limit_ = 906,          /* -fconstexpr-loop-limit= */
  OPT_fconstexpr_ops_limit_ = 907,           /* -fconstexpr-ops-limit= */
  OPT_fconvert_ = 908,                       /* -fconvert= */
  OPT_fcoroutines = 909,                     /* -fcoroutines */
  OPT_fcpp = 910,                            /* -fcpp */
  OPT_fcppbegin = 911,                       /* -fcppbegin */
  OPT_fcppend = 912,                         /* -fcppend */
  OPT_fcppprog_ = 913,                       /* -fcppprog= */
  OPT_fcprop_registers = 914,                /* -fcprop-registers */
  OPT_fcray_pointer = 915,                   /* -fcray-pointer */
  OPT_fcrossjumping = 916,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 917,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 918, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 919,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 920,               /* -fcx-limited-range */
  OPT_fd = 921,                              /* -fd */
  OPT_fd_lines_as_code = 922,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 923,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 924,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 925,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 926,                       /* -fdbg-cnt= */
  OPT_fdce = 927,                            /* -fdce */
  OPT_fdebug = 928,                          /* -fdebug */
  OPT_fdebug_builtins = 929,                 /* -fdebug-builtins */
  OPT_fdebug_cpp = 930,                      /* -fdebug-cpp */
  OPT_fdebug_function_line_numbers = 931,    /* -fdebug-function-line-numbers */
  OPT_fdebug_prefix_map_ = 932,              /* -fdebug-prefix-map= */
  OPT_fdebug_trace_api = 933,                /* -fdebug-trace-api */
  OPT_fdebug_trace_quad = 934,               /* -fdebug-trace-quad */
  OPT_fdebug_types_section = 935,            /* -fdebug-types-section */
  OPT_fdebug_ = 936,                         /* -fdebug= */
  OPT_fdec = 937,                            /* -fdec */
  OPT_fdec_blank_format_item = 938,          /* -fdec-blank-format-item */
  OPT_fdec_char_conversions = 939,           /* -fdec-char-conversions */
  OPT_fdec_format_defaults = 940,            /* -fdec-format-defaults */
  OPT_fdec_include = 941,                    /* -fdec-include */
  OPT_fdec_intrinsic_ints = 942,             /* -fdec-intrinsic-ints */
  OPT_fdec_math = 943,                       /* -fdec-math */
  OPT_fdec_static = 944,                     /* -fdec-static */
  OPT_fdec_structure = 945,                  /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 946,              /* -fdeclone-ctor-dtor */
  /* OPT_fdeduce_init_list = 947, */         /* -fdeduce-init-list */
  OPT_fdef_ = 948,                           /* -fdef= */
  OPT_fdefault_double_8 = 949,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 950, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 951,              /* -fdefault-integer-8 */
  OPT_fdefault_real_10 = 952,                /* -fdefault-real-10 */
  OPT_fdefault_real_16 = 953,                /* -fdefault-real-16 */
  OPT_fdefault_real_8 = 954,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 955,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 956,                 /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 957,         /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 958,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 959,                   /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 960,         /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 961,     /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 962, */        /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 963,             /* -fdiagnostics-color= */
  OPT_fdiagnostics_format_ = 964,            /* -fdiagnostics-format= */
  OPT_fdiagnostics_generate_patch = 965,     /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_minimum_margin_width_ = 966,/* -fdiagnostics-minimum-margin-width= */
  OPT_fdiagnostics_parseable_fixits = 967,   /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_path_format_ = 968,       /* -fdiagnostics-path-format= */
  OPT_fdiagnostics_show_caret = 969,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_cwe = 970,           /* -fdiagnostics-show-cwe */
  OPT_fdiagnostics_show_labels = 971,        /* -fdiagnostics-show-labels */
  OPT_fdiagnostics_show_line_numbers = 972,  /* -fdiagnostics-show-line-numbers */
  OPT_fdiagnostics_show_location_ = 973,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 974,        /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_path_depths = 975,   /* -fdiagnostics-show-path-depths */
  OPT_fdiagnostics_show_template_tree = 976, /* -fdiagnostics-show-template-tree */
  OPT_fdiagnostics_urls_ = 977,              /* -fdiagnostics-urls= */
  OPT_fdirectives_only = 978,                /* -fdirectives-only */
  OPT_fdisable_ = 979,                       /* -fdisable- */
  OPT_fdoc = 980,                            /* -fdoc */
  OPT_fdoc_dir_ = 981,                       /* -fdoc-dir= */
  OPT_fdoc_file_ = 982,                      /* -fdoc-file= */
  OPT_fdoc_inc_ = 983,                       /* -fdoc-inc= */
  OPT_fdollar_ok = 984,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 985,         /* -fdollars-in-identifiers */
  OPT_fdruntime = 986,                       /* -fdruntime */
  OPT_fdse = 987,                            /* -fdse */
  OPT_fdump_ = 988,                          /* -fdump- */
  OPT_fdump_ada_spec = 989,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 990,             /* -fdump-ada-spec-slim */
  OPT_fdump_analyzer = 991,                  /* -fdump-analyzer */
  OPT_fdump_analyzer_callgraph = 992,        /* -fdump-analyzer-callgraph */
  OPT_fdump_analyzer_exploded_graph = 993,   /* -fdump-analyzer-exploded-graph */
  OPT_fdump_analyzer_exploded_nodes = 994,   /* -fdump-analyzer-exploded-nodes */
  OPT_fdump_analyzer_exploded_nodes_2 = 995, /* -fdump-analyzer-exploded-nodes-2 */
  OPT_fdump_analyzer_exploded_nodes_3 = 996, /* -fdump-analyzer-exploded-nodes-3 */
  OPT_fdump_analyzer_state_purge = 997,      /* -fdump-analyzer-state-purge */
  OPT_fdump_analyzer_stderr = 998,           /* -fdump-analyzer-stderr */
  OPT_fdump_analyzer_supergraph = 999,       /* -fdump-analyzer-supergraph */
  /* OPT_fdump_core = 1000, */               /* -fdump-core */
  OPT_fdump_d_original = 1001,               /* -fdump-d-original */
  OPT_fdump_final_insns = 1002,              /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 1003,             /* -fdump-final-insns= */
  OPT_fdump_fortran_global = 1004,           /* -fdump-fortran-global */
  OPT_fdump_fortran_optimized = 1005,        /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 1006,         /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 1007,                 /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 1008,       /* -fdump-internal-locations */
  OPT_fdump_noaddr = 1009,                   /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 1010, */         /* -fdump-parse-tree */
  OPT_fdump_passes = 1011,                   /* -fdump-passes */
  OPT_fdump_scos = 1012,                     /* -fdump-scos */
  OPT_fdump_system_exports = 1013,           /* -fdump-system-exports */
  OPT_fdump_unnumbered = 1014,               /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 1015,         /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 1016,                /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 1017,                /* -fearly-inlining */
  OPT_felide_constructors = 1018,            /* -felide-constructors */
  OPT_felide_type = 1019,                    /* -felide-type */
  /* OPT_feliminate_dwarf2_dups = 1020, */   /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 1021,/* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 1022,  /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 1023,       /* -femit-class-debug-always */
  OPT_femit_struct_debug_baseonly = 1024,    /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 1025,   /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 1026,     /* -femit-struct-debug-reduced */
  OPT_fenable_ = 1027,                       /* -fenable- */
  OPT_fenforce_eh_specs = 1028,              /* -fenforce-eh-specs */
  OPT_fenum_int_equiv = 1029,                /* -fenum-int-equiv */
  OPT_fexceptions = 1030,                    /* -fexceptions */
  OPT_fexcess_precision_ = 1031,             /* -fexcess-precision= */
  OPT_fexec_charset_ = 1032,                 /* -fexec-charset= */
  OPT_fexpensive_optimizations = 1033,       /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 1034,          /* -fext-numeric-literals */
  OPT_fextended_identifiers = 1035,          /* -fextended-identifiers */
  OPT_fextended_opaque = 1036,               /* -fextended-opaque */
  OPT_fextern_tls_init = 1037,               /* -fextern-tls-init */
  OPT_fexternal_blas = 1038,                 /* -fexternal-blas */
  OPT_fexternal_templates = 1039,            /* -fexternal-templates */
  OPT_ff2c = 1040,                           /* -ff2c */
  OPT_ffast_math = 1041,                     /* -ffast-math */
  OPT_ffat_lto_objects = 1042,               /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 1043,              /* -ffile-prefix-map= */
  OPT_ffinite_loops = 1044,                  /* -ffinite-loops */
  OPT_ffinite_math_only = 1045,              /* -ffinite-math-only */
  OPT_ffixed_ = 1046,                        /* -ffixed- */
  OPT_ffixed_form = 1047,                    /* -ffixed-form */
  OPT_ffixed_line_length_ = 1048,            /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 1049,        /* -ffixed-line-length-none */
  OPT_ffloat_store = 1050,                   /* -ffloat-store */
  OPT_ffloatvalue = 1051,                    /* -ffloatvalue */
  OPT_ffor_scope = 1052,                     /* -ffor-scope */
  /* OPT_fforce_addr = 1053, */              /* -fforce-addr */
  OPT_fforward_propagate = 1054,             /* -fforward-propagate */
  OPT_ffp_contract_ = 1055,                  /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 1056,        /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 1057,                  /* -ffpe-summary= */
  OPT_ffpe_trap_ = 1058,                     /* -ffpe-trap= */
  OPT_ffree_form = 1059,                     /* -ffree-form */
  OPT_ffree_line_length_ = 1060,             /* -ffree-line-length- */
  OPT_ffree_line_length_none = 1061,         /* -ffree-line-length-none */
  OPT_ffreestanding = 1062,                  /* -ffreestanding */
  OPT_ffriend_injection = 1063,              /* -ffriend-injection */
  OPT_ffrontend_loop_interchange = 1064,     /* -ffrontend-loop-interchange */
  OPT_ffrontend_optimize = 1065,             /* -ffrontend-optimize */
  OPT_ffunction_cse = 1066,                  /* -ffunction-cse */
  OPT_ffunction_sections = 1067,             /* -ffunction-sections */
  OPT_fgcse = 1068,                          /* -fgcse */
  OPT_fgcse_after_reload = 1069,             /* -fgcse-after-reload */
  OPT_fgcse_las = 1070,                      /* -fgcse-las */
  OPT_fgcse_lm = 1071,                       /* -fgcse-lm */
  OPT_fgcse_sm = 1072,                       /* -fgcse-sm */
  OPT_fgimple = 1073,                        /* -fgimple */
  OPT_fgnat_encodings_ = 1074,               /* -fgnat-encodings= */
  OPT_fgnu_keywords = 1075,                  /* -fgnu-keywords */
  OPT_fgnu_runtime = 1076,                   /* -fgnu-runtime */
  OPT_fgnu_tm = 1077,                        /* -fgnu-tm */
  OPT_fgnu_unique = 1078,                    /* -fgnu-unique */
  OPT_fgnu89_inline = 1079,                  /* -fgnu89-inline */
  OPT_fgo_c_header_ = 1080,                  /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 1081,      /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 1082,          /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 1083,          /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 1084,               /* -fgo-debug-escape */
  OPT_fgo_debug_escape_hash_ = 1085,         /* -fgo-debug-escape-hash= */
  OPT_fgo_debug_optimization = 1086,         /* -fgo-debug-optimization */
  OPT_fgo_dump_ = 1087,                      /* -fgo-dump- */
  OPT_fgo_optimize_ = 1088,                  /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 1089,                   /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 1090,                    /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 1091,      /* -fgo-relative-import-path= */
  OPT_fgraphite = 1092,                      /* -fgraphite */
  OPT_fgraphite_identity = 1093,             /* -fgraphite-identity */
  OPT_fguess_branch_probability = 1094,      /* -fguess-branch-probability */
  OPT_fguiding_decls = 1095,                 /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 1096, */       /* -fhandle-exceptions */
  /* OPT_fhelp = 1097, */                    /* -fhelp */
  /* OPT_fhelp_ = 1098, */                   /* -fhelp= */
  OPT_fhoist_adjacent_loads = 1099,          /* -fhoist-adjacent-loads */
  OPT_fhonor_std = 1100,                     /* -fhonor-std */
  OPT_fhosted = 1101,                        /* -fhosted */
  OPT_fhuge_objects = 1102,                  /* -fhuge-objects */
  OPT_fident = 1103,                         /* -fident */
  OPT_fif_conversion = 1104,                 /* -fif-conversion */
  OPT_fif_conversion2 = 1105,                /* -fif-conversion2 */
  OPT_fignore_unknown_pragmas = 1106,        /* -fignore-unknown-pragmas */
  OPT_fimplement_inlines = 1107,             /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 1108,     /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 1109,                 /* -fimplicit-none */
  OPT_fimplicit_templates = 1110,            /* -fimplicit-templates */
  OPT_findex = 1111,                         /* -findex */
  OPT_findirect_inlining = 1112,             /* -findirect-inlining */
  OPT_finhibit_size_directive = 1113,        /* -finhibit-size-directive */
  OPT_finit_character_ = 1114,               /* -finit-character= */
  OPT_finit_derived = 1115,                  /* -finit-derived */
  OPT_finit_integer_ = 1116,                 /* -finit-integer= */
  OPT_finit_local_zero = 1117,               /* -finit-local-zero */
  OPT_finit_logical_ = 1118,                 /* -finit-logical= */
  OPT_finit_real_ = 1119,                    /* -finit-real= */
  OPT_finline = 1120,                        /* -finline */
  OPT_finline_arg_packing = 1121,            /* -finline-arg-packing */
  OPT_finline_atomics = 1122,                /* -finline-atomics */
  OPT_finline_functions = 1123,              /* -finline-functions */
  OPT_finline_functions_called_once = 1124,  /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 1125, */           /* -finline-limit- */
  OPT_finline_limit_ = 1126,                 /* -finline-limit= */
  OPT_finline_matmul_limit_ = 1127,          /* -finline-matmul-limit= */
  OPT_finline_small_functions = 1128,        /* -finline-small-functions */
  OPT_finput_charset_ = 1129,                /* -finput-charset= */
  OPT_finstrument_functions = 1130,          /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 1131,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 1132,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 1133,           /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 1134,        /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 1135,       /* -fintrinsic-modules-path= */
  OPT_finvariants = 1136,                    /* -finvariants */
  OPT_fipa_bit_cp = 1137,                    /* -fipa-bit-cp */
  OPT_fipa_cp = 1138,                        /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 1139, */        /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 1140,                  /* -fipa-cp-clone */
  OPT_fipa_icf = 1141,                       /* -fipa-icf */
  OPT_fipa_icf_functions = 1142,             /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 1143,             /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 1144, */        /* -fipa-matrix-reorg */
  OPT_fipa_profile = 1145,                   /* -fipa-profile */
  OPT_fipa_pta = 1146,                       /* -fipa-pta */
  OPT_fipa_pure_const = 1147,                /* -fipa-pure-const */
  OPT_fipa_ra = 1148,                        /* -fipa-ra */
  OPT_fipa_reference = 1149,                 /* -fipa-reference */
  OPT_fipa_reference_addressable = 1150,     /* -fipa-reference-addressable */
  OPT_fipa_sra = 1151,                       /* -fipa-sra */
  OPT_fipa_stack_alignment = 1152,           /* -fipa-stack-alignment */
  /* OPT_fipa_struct_reorg = 1153, */        /* -fipa-struct-reorg */
  OPT_fipa_vrp = 1154,                       /* -fipa-vrp */
  OPT_fira_algorithm_ = 1155,                /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 1156,            /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 1157,             /* -fira-loop-pressure */
  OPT_fira_region_ = 1158,                   /* -fira-region= */
  OPT_fira_share_save_slots = 1159,          /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 1160,         /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 1161,                  /* -fira-verbose= */
  OPT_fiso = 1162,                           /* -fiso */
  OPT_fisolate_erroneous_paths_attribute = 1163,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 1164,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 1165,              /* -fivar-visibility= */
  OPT_fivopts = 1166,                        /* -fivopts */
  OPT_fjump_tables = 1167,                   /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 1168,            /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 1169,         /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 1170,         /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 1171,            /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 1172,         /* -fkeep-static-functions */
  OPT_flabels_ok = 1173,                     /* -flabels-ok */
  OPT_flax_vector_conversions = 1174,        /* -flax-vector-conversions */
  OPT_fleading_underscore = 1175,            /* -fleading-underscore */
  OPT_flibs_ = 1176,                         /* -flibs= */
  OPT_flifetime_dse = 1177,                  /* -flifetime-dse */
  OPT_flifetime_dse_ = 1178,                 /* -flifetime-dse= */
  OPT_flimit_function_alignment = 1179,      /* -flimit-function-alignment */
  OPT_flinker_output_ = 1180,                /* -flinker-output= */
  /* OPT_flive_patching = 1181, */           /* -flive-patching */
  OPT_flive_patching_ = 1182,                /* -flive-patching= */
  OPT_flive_range_shrinkage = 1183,          /* -flive-range-shrinkage */
  OPT_flocal_ivars = 1184,                   /* -flocal-ivars */
  OPT_flocation_ = 1185,                     /* -flocation= */
  /* OPT_floop_block = 1186, */              /* -floop-block */
  /* OPT_floop_flatten = 1187, */            /* -floop-flatten */
  OPT_floop_interchange = 1188,              /* -floop-interchange */
  OPT_floop_nest_optimize = 1189,            /* -floop-nest-optimize */
  /* OPT_floop_optimize = 1190, */           /* -floop-optimize */
  OPT_floop_parallelize_all = 1191,          /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 1192, */         /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 1193,           /* -floop-unroll-and-jam */
  OPT_flra_remat = 1194,                     /* -flra-remat */
  OPT_flto = 1195,                           /* -flto */
  OPT_flto_compression_level_ = 1196,        /* -flto-compression-level= */
  /* OPT_flto_odr_type_merging = 1197, */    /* -flto-odr-type-merging */
  OPT_flto_partition_ = 1198,                /* -flto-partition= */
  OPT_flto_report = 1199,                    /* -flto-report */
  OPT_flto_report_wpa = 1200,                /* -flto-report-wpa */
  OPT_flto_ = 1201,                          /* -flto= */
  OPT_fltrans = 1202,                        /* -fltrans */
  OPT_fltrans_output_list_ = 1203,           /* -fltrans-output-list= */
  OPT_fm2_g = 1204,                          /* -fm2-g */
  OPT_fm2_lower_case = 1205,                 /* -fm2-lower-case */
  OPT_fm2_plugin = 1206,                     /* -fm2-plugin */
  OPT_fm2_statistics = 1207,                 /* -fm2-statistics */
  OPT_fm2_strict_type = 1208,                /* -fm2-strict-type */
  OPT_fm2_version = 1209,                    /* -fm2-version */
  OPT_fm2_whole_program = 1210,              /* -fm2-whole-program */
  OPT_fmacro_prefix_map_ = 1211,             /* -fmacro-prefix-map= */
  OPT_fmain = 1212,                          /* -fmain */
  OPT_fmakeinit = 1213,                      /* -fmakeinit */
  OPT_fmakelist = 1214,                      /* -fmakelist */
  OPT_fmath_errno = 1215,                    /* -fmath-errno */
  OPT_fmax_array_constructor_ = 1216,        /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 1217,                   /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 1218,        /* -fmax-identifier-length= */
  OPT_fmax_include_depth_ = 1219,            /* -fmax-include-depth= */
  OPT_fmax_stack_var_size_ = 1220,           /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 1221,         /* -fmax-subrecord-length= */
  OPT_fmem_report = 1222,                    /* -fmem-report */
  OPT_fmem_report_wpa = 1223,                /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 1224,           /* -fmerge-all-constants */
  OPT_fmerge_constants = 1225,               /* -fmerge-constants */
  OPT_fmerge_debug_strings = 1226,           /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 1227,               /* -fmessage-length= */
  OPT_fmod_ = 1228,                          /* -fmod= */
  OPT_fmodule_file_ = 1229,                  /* -fmodule-file= */
  OPT_fmodule_private = 1230,                /* -fmodule-private */
  OPT_fmoduleinfo = 1231,                    /* -fmoduleinfo */
  OPT_fmodules = 1232,                       /* -fmodules */
  ...
  OPT_fnil = 1245,                           /* -fnil */
  OPT_fnil_receivers = 1246,                 /* -fnil-receivers */
  OPT_fno_m2_plugin = 1247,                  /* -fno-m2-plugin */
  OPT_fno_pthread = 1248,                    /* -fno-pthread */
  OPT_fnon_call_exceptions = 1249,           /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 1250,              /* -fnonansi-builtins */
  OPT_fnonnull_objects = 1251,               /* -fnonnull-objects */
  OPT_fnothrow_opt = 1252,                   /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 1253,             /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 1254,          /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 1255,          /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 1256,               /* -fobjc-exceptions */
  OPT_fobjc_gc = 1257,                       /* -fobjc-gc */
  OPT_fobjc_nilcheck = 1258,                 /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 1259,          /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 1260,                /* -fobjc-std=objc1 */
  OPT_fobject_path_ = 1261,                  /* -fobject-path= */
  ...
  OPT_fonlylink = 1266,                      /* -fonlylink */
  OPT_fopenacc = 1267,                       /* -fopenacc */
  OPT_fopenacc_dim_ = 1268,                  /* -fopenacc-dim= */
  OPT_fopenmp = 1269,                        /* -fopenmp */
  OPT_fopenmp_simd = 1270,                   /* -fopenmp-simd */
  OPT_foperator_names = 1271,                /* -foperator-names */
  OPT_fopt_info = 1272,                      /* -fopt-info */
  OPT_fopt_info_ = 1273,                     /* -fopt-info- */
  /* OPT_foptimize_register_move = 1274, */  /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 1275,        /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 1276,               /* -foptimize-strlen */
  /* OPT_foptional_diags = 1277, */          /* -foptional-diags */
  OPT_fpack_derived = 1278,                  /* -fpack-derived */
  OPT_fpack_struct = 1279,                   /* -fpack-struct */
  OPT_fpack_struct_ = 1280,                  /* -fpack-struct= */
  OPT_fpad_source = 1281,                    /* -fpad-source */
  OPT_fpartial_inlining = 1282,              /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 1283,     /* -fpatchable-function-entry= */
  OPT_fpcc_struct_return = 1284,             /* -fpcc-struct-return */
  OPT_fpch_deps = 1285,                      /* -fpch-deps */
  OPT_fpch_preprocess = 1286,                /* -fpch-preprocess */
  OPT_fpeel_loops = 1287,                    /* -fpeel-loops */
  OPT_fpeephole = 1288,                      /* -fpeephole */
  OPT_fpeephole2 = 1289,                     /* -fpeephole2 */
  OPT_fpermissive = 1290,                    /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 1291,   /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 1292,                           /* -fpic */
  OPT_fpie = 1293,                           /* -fpie */
  OPT_fpim = 1294,                           /* -fpim */
  OPT_fpim2 = 1295,                          /* -fpim2 */
  OPT_fpim3 = 1296,                          /* -fpim3 */
  OPT_fpim4 = 1297,                          /* -fpim4 */
  OPT_fplan9_extensions = 1298,              /* -fplan9-extensions */
  OPT_fplt = 1299,                           /* -fplt */
  OPT_fplugin_arg_ = 1300,                   /* -fplugin-arg- */
  OPT_fplugin_ = 1301,                       /* -fplugin= */
  OPT_fpositive_mod_floor_div = 1302,        /* -fpositive-mod-floor-div */
  OPT_fpost_ipa_mem_report = 1303,           /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 1304,                /* -fpostconditions */
  OPT_fpre_include_ = 1305,                  /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 1306,            /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 1307,                 /* -fpreconditions */
  OPT_fpredictive_commoning = 1308,          /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 1309,          /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 1310,                  /* -fpreprocessed */
  OPT_fpretty_templates = 1311,              /* -fpretty-templates */
  OPT_fprintf_return_value = 1312,           /* -fprintf-return-value */
  OPT_fprofile = 1313,                       /* -fprofile */
  OPT_fprofile_abs_path = 1314,              /* -fprofile-abs-path */
  OPT_fprofile_arcs = 1315,                  /* -fprofile-arcs */
  OPT_fprofile_correction = 1316,            /* -fprofile-correction */
  OPT_fprofile_dir_ = 1317,                  /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 1318,        /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 1319,         /* -fprofile-filter-files= */
  OPT_fprofile_generate = 1320,              /* -fprofile-generate */
  OPT_fprofile_generate_ = 1321,             /* -fprofile-generate= */
  OPT_fprofile_note_ = 1322,                 /* -fprofile-note= */
  OPT_fprofile_partial_training = 1323,      /* -fprofile-partial-training */
  OPT_fprofile_prefix_path_ = 1324,          /* -fprofile-prefix-path= */
  OPT_fprofile_reorder_functions = 1325,     /* -fprofile-reorder-functions */
  OPT_fprofile_report = 1326,                /* -fprofile-report */
  OPT_fprofile_reproducible = 1327,          /* -fprofile-reproducible */
  OPT_fprofile_update_ = 1328,               /* -fprofile-update= */
  OPT_fprofile_use = 1329,                   /* -fprofile-use */
  OPT_fprofile_use_ = 1330,                  /* -fprofile-use= */
  OPT_fprofile_values = 1331,                /* -fprofile-values */
  OPT_fprotect_parens = 1332,                /* -fprotect-parens */
  OPT_fq = 1333,                             /* -fq */
  OPT_frandom_seed = 1334,                   /* -frandom-seed */
  OPT_frandom_seed_ = 1335,                  /* -frandom-seed= */
  OPT_frange = 1336,                         /* -frange */
  OPT_frange_check = 1337,                   /* -frange-check */
  OPT_freal_4_real_10 = 1338,                /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 1339,                /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 1340,                 /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 1341,                /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 1342,                /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 1343,                 /* -freal-8-real-4 */
  OPT_frealloc_lhs = 1344,                   /* -frealloc-lhs */
  OPT_freciprocal_math = 1345,               /* -freciprocal-math */
  OPT_frecord_gcc_switches = 1346,           /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 1347,               /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 1348,               /* -frecord-marker=8 */
  OPT_frecursive = 1349,                     /* -frecursive */
  OPT_free = 1350,                           /* -free */
  OPT_freg_struct_return = 1351,             /* -freg-struct-return */
  /* OPT_fregmove = 1352, */                 /* -fregmove */
  OPT_frelease = 1353,                       /* -frelease */
  OPT_frename_registers = 1354,              /* -frename-registers */
  OPT_freorder_blocks = 1355,                /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 1356,     /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 1357,  /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 1358,             /* -freorder-functions */
  OPT_frepack_arrays = 1359,                 /* -frepack-arrays */
  OPT_freplace_objc_classes = 1360,          /* -freplace-objc-classes */
  OPT_frepo = 1361,                          /* -frepo */
  OPT_freport_bug = 1362,                    /* -freport-bug */
  OPT_frequire_return_statement = 1363,      /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 1364,          /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 1365, */          /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 1366,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 1367,                   /* -fresolution= */
  OPT_freturn = 1368,                        /* -freturn */
  OPT_frounding_math = 1369,                 /* -frounding-math */
  OPT_frtti = 1370,                          /* -frtti */
  OPT_fruntime_modules_ = 1371,              /* -fruntime-modules= */
  OPT_fsanitize_address_use_after_scope = 1372,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1373,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1374,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1375,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1376,            /* -fsanitize-sections= */
  OPT_fsanitize_undefined_trap_on_error = 1377,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1378,                     /* -fsanitize= */
  OPT_fsave_optimization_record = 1379,      /* -fsave-optimization-record */
  OPT_fsched_critical_path_heuristic = 1380, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1381,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1382,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1383,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1384,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1385,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1386,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1387,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1388,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1389,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1390,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1391,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1392,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1393,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1394,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1395,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1396,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1397, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1398,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1399,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1400,               /* -fschedule-insns2 */
  OPT_fsecond_underscore = 1401,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1402,               /* -fsection-anchors */
  /* OPT_fsee = 1403, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1404,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1405,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1406,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1407,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1408,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1409,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1410,        /* -fsemantic-interposition */
  OPT_fshared = 1411,                        /* -fshared */
  OPT_fshort_enums = 1412,                   /* -fshort-enums */
  OPT_fshort_wchar = 1413,                   /* -fshort-wchar */
  OPT_fshow_column = 1414,                   /* -fshow-column */
  OPT_fshrink_wrap = 1415,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1416,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1417,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1418,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1419,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1420,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1421,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1422,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1423,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1424,            /* -fsized-deallocation */
  OPT_fsoft_check_all = 1425,                /* -fsoft-check-all */
  OPT_fsources = 1426,                       /* -fsources */
  OPT_fsplit_ivs_in_unroller = 1427,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1428,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1429,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1430,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1431,              /* -fsplit-wide-types */
  OPT_fsplit_wide_types_early = 1432,        /* -fsplit-wide-types-early */
  OPT_fsquangle = 1433,                      /* -fsquangle */
  OPT_fssa_backprop = 1434,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1435,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1436,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1437,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1438, */             /* -fstack-check */
  OPT_fstack_check_ = 1439,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1440,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1441,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1442,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1443,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1444,               /* -fstack-protector */
  OPT_fstack_protector_all = 1445,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1446,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1447,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1448,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1449,                   /* -fstack-usage */
  OPT_fstats = 1450,                         /* -fstats */
  OPT_fstdarg_opt = 1451,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1452,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1453, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1454,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1455,                  /* -fstrict-enums */
  OPT_fstrict_overflow = 1456,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1457,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1458,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1459, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1460,            /* -fstrong-eval-order= */
  OPT_fswig = 1461,                          /* -fswig */
  ...
  OPT_ftarget_ar_ = 1468,                    /* -ftarget-ar= */
  /* OPT_ftarget_help = 1469, */             /* -ftarget-help */
  OPT_ftarget_ranlib_ = 1470,                /* -ftarget-ranlib= */
  OPT_ftemplate_backtrace_limit_ = 1471,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1472, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1473,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1474,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1475,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1476,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1477,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1478,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1479,                   /* -ftime-report */
  OPT_ftime_report_details = 1480,           /* -ftime-report-details */
  OPT_ftls_model_ = 1481,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1482,              /* -ftoplevel-reorder */
  OPT_ftracer = 1483,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1484,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1485,        /* -ftrack-macro-expansion= */
  OPT_ftrampolines = 1486,                   /* -ftrampolines */
  OPT_ftransition_all = 1487,                /* -ftransition=all */
  OPT_ftransition_checkimports = 1488,       /* -ftransition=checkimports */
  OPT_ftransition_complex = 1489,            /* -ftransition=complex */
  OPT_ftransition_dip1000 = 1490,            /* -ftransition=dip1000 */
  OPT_ftransition_dip25 = 1491,              /* -ftransition=dip25 */
  OPT_ftransition_field = 1492,              /* -ftransition=field */
  OPT_ftransition_import = 1493,             /* -ftransition=import */
  OPT_ftransition_nogc = 1494,               /* -ftransition=nogc */
  OPT_ftransition_tls = 1495,                /* -ftransition=tls */
  OPT_ftrapping_math = 1496,                 /* -ftrapping-math */
  OPT_ftrapv = 1497,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1498,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1499,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1500,                      /* -ftree-ccp */
  OPT_ftree_ch = 1501,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1502, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1503,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1504,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1505, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1506,                   /* -ftree-cselim */
  OPT_ftree_dce = 1507,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1508,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1509,                      /* -ftree-dse */
  ...
  OPT_ftree_slp_vectorize = 1531,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1532,                     /* -ftree-slsr */
  OPT_ftree_sra = 1533,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1534, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1535, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1536,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1537,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1538,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1539, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1540,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1541, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1542,                      /* -ftree-vrp */
  OPT_funbounded_by_reference = 1543,        /* -funbounded-by-reference */
  OPT_funconstrained_commons = 1544,         /* -funconstrained-commons */
  OPT_funderscoring = 1545,                  /* -funderscoring */
  OPT_funit_at_a_time = 1546,                /* -funit-at-a-time */
  OPT_funittest = 1547,                      /* -funittest */
  OPT_funroll_all_loops = 1548,              /* -funroll-all-loops */
  OPT_funroll_completely_grow_size = 1549,   /* -funroll-completely-grow-size */
  OPT_funroll_loops = 1550,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1551, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1552,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1553,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1554,                 /* -funsigned-char */
  OPT_funswitch_loops = 1555,                /* -funswitch-loops */
  OPT_funwind_tables = 1556,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1557,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1558,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1559,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1560,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1561,                    /* -fuse-ld=lld */
  OPT_fuse_linker_plugin = 1562,             /* -fuse-linker-plugin */
  OPT_fuselist = 1563,                       /* -fuselist */
  OPT_fvar_tracking = 1564,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1565,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1566,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1567,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1568,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1569, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1570,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1571,                   /* -fverbose-asm */
  /* OPT_fversion = 1572, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1573,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1574,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1575,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1576,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1577,                   /* -fvisibility= */
  OPT_fvpt = 1578,                           /* -fvpt */
  OPT_fvtable_gc = 1579,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1580,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1581,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1582,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1583,                     /* -fvtv-debug */
  OPT_fweak = 1584,                          /* -fweak */
  OPT_fweb = 1585,                           /* -fweb */
  /* OPT_fwhole_file = 1586, */              /* -fwhole-file */
  OPT_fwhole_program = 1587,                 /* -fwhole-program */
  OPT_fwholediv = 1588,                      /* -fwholediv */
  OPT_fwholevalue = 1589,                    /* -fwholevalue */
  OPT_fwide_exec_charset_ = 1590,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1591,             /* -fworking-directory */
  OPT_fwpa = 1592,                           /* -fwpa */
  OPT_fwpa_ = 1593,                          /* -fwpa= */
  OPT_fwrapv = 1594,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1595,                 /* -fwrapv-pointer */
  OPT_fxcode = 1596,                         /* -fxcode */
  OPT_fxref = 1597,                          /* -fxref */
  /* OPT_fzee = 1598, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1599,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1600,                     /* -fzero-link */
  OPT_g = 1601,                              /* -g */
  OPT_gant = 1602,                           /* -gant */
  OPT_gas_loc_support = 1603,                /* -gas-loc-support */
  OPT_gas_locview_support = 1604,            /* -gas-locview-support */
  OPT_gcoff = 1605,                          /* -gcoff */
  OPT_gcoff1 = 1606,                         /* -gcoff1 */
  OPT_gcoff2 = 1607,                         /* -gcoff2 */
  OPT_gcoff3 = 1608,                         /* -gcoff3 */
  OPT_gcolumn_info = 1609,                   /* -gcolumn-info */
  OPT_gdescribe_dies = 1610,                 /* -gdescribe-dies */
  OPT_gdwarf = 1611,                         /* -gdwarf */
  OPT_gdwarf_ = 1612,                        /* -gdwarf- */
  OPT_gen_decls = 1613,                      /* -gen-decls */
  OPT_ggdb = 1614,                           /* -ggdb */
  OPT_ggnu_pubnames = 1615,                  /* -ggnu-pubnames */
  OPT_gimple_stats = 1616,                   /* -gimple-stats */
  OPT_ginline_points = 1617,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 1618, /* -ginternal-reset-location-views */
  OPT_gnat = 1619,                           /* -gnat */
  OPT_gnatO = 1620,                          /* -gnatO */
  OPT_gno_ = 1621,                           /* -gno- */
  OPT_gno_pubnames = 1622,                   /* -gno-pubnames */
  OPT_gpubnames = 1623,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1624,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1625,                   /* -gsplit-dwarf */
  OPT_gstabs = 1626,                         /* -gstabs */
  OPT_gstabs_ = 1627,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 1628,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 1629,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1630,                        /* -gtoggle */
  OPT_gvariable_location_views = 1631,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1632,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1633,                           /* -gvms */
  OPT_gxcoff = 1634,                         /* -gxcoff */
  OPT_gxcoff_ = 1635,                        /* -gxcoff+ */
  OPT_gz = 1636,                             /* -gz */
  OPT_gz_ = 1637,                            /* -gz= */
  OPT_h = 1638,                              /* -h */
  OPT_help = 1639,                           /* -help */
  OPT_idirafter = 1640,                      /* -idirafter */
  OPT_imacros = 1641,                        /* -imacros */
  OPT_imultiarch = 1642,                     /* -imultiarch */
  OPT_imultilib = 1643,                      /* -imultilib */
  OPT_include = 1644,                        /* -include */
  OPT_iplugindir_ = 1645,                    /* -iplugindir= */
  OPT_iprefix = 1646,                        /* -iprefix */
  OPT_iquote = 1647,                         /* -iquote */
  OPT_isysroot = 1648,                       /* -isysroot */
  OPT_isystem = 1649,                        /* -isystem */
  OPT_iwithprefix = 1650,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1651,              /* -iwithprefixbefore */
  OPT_k8 = 1652,                             /* -k8 */
  OPT_l = 1653,                              /* -l */
  OPT_lang_asm = 1654,                       /* -lang-asm */
  OPT_list = 1655,                           /* -list */
  OPT_mabi_ = 1656,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1657,             /* -mabort-on-noreturn */
  OPT_mandroid = 1658,                       /* -mandroid */
  OPT_mapcs = 1659,                          /* -mapcs */
  OPT_mapcs_frame = 1660,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1661,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1662,              /* -mapcs-stack-check */
  OPT_march_ = 1663,                         /* -march= */
  OPT_marm = 1664,                           /* -marm */
  OPT_masm_syntax_unified = 1665,            /* -masm-syntax-unified */
  OPT_mbe32 = 1666,                          /* -mbe32 */
  OPT_mbe8 = 1667,                           /* -mbe8 */
  OPT_mbig_endian = 1668,                    /* -mbig-endian */
  OPT_mbionic = 1669,                        /* -mbionic */
  OPT_mbranch_cost_ = 1670,                  /* -mbranch-cost= */
  OPT_mcallee_super_interworking = 1671,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1672,     /* -mcaller-super-interworking */
  OPT_mcmse = 1673,                          /* -mcmse */
  OPT_mcpu_ = 1674,                          /* -mcpu= */
  OPT_mfdpic = 1675,                         /* -mfdpic */
  OPT_mfix_cortex_m3_ldrd = 1676,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1677,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1678,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1679,                  /* -mfp16-format= */
  OPT_mfpu_ = 1680,                          /* -mfpu= */
  OPT_mgeneral_regs_only = 1681,             /* -mgeneral-regs-only */
  OPT_mglibc = 1682,                         /* -mglibc */
  /* OPT_mhard_float = 1683, */              /* -mhard-float */
  OPT_mlittle_endian = 1684,                 /* -mlittle-endian */
  OPT_mlong_calls = 1685,                    /* -mlong-calls */
  OPT_mmusl = 1686,                          /* -mmusl */
  OPT_mneon_for_64bits = 1687,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1688,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1689,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1690,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1691,               /* -mprint-tune-info */
  OPT_mpure_code = 1692,                     /* -mpure-code */
  OPT_mrestrict_it = 1693,                   /* -mrestrict-it */
  OPT_msched_prolog = 1694,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1695,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1696,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1697, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1698,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1699,                         /* -mthumb */
  OPT_mthumb_interwork = 1700,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1701,                  /* -mtls-dialect= */
  OPT_mtp_ = 1702,                           /* -mtp= */
  OPT_mtpcs_frame = 1703,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1704,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1705,                         /* -mtune= */
  OPT_muclibc = 1706,                        /* -muclibc */
  OPT_munaligned_access = 1707,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1708,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1709,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 1710,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 1711,              /* -mword-relocations */
  OPT_n = 1712,                              /* -n */
  ...
  OPT_std_c__98 = 1785,                      /* -std=c++98 */
  OPT_std_c11 = 1786,                        /* -std=c11 */
  OPT_std_c17 = 1787,                        /* -std=c17 */
  /* OPT_std_c18 = 1788, */                  /* -std=c18 */
  /* OPT_std_c1x = 1789, */                  /* -std=c1x */
  OPT_std_c2x = 1790,                        /* -std=c2x */
  /* OPT_std_c89 = 1791, */                  /* -std=c89 */
  OPT_std_c90 = 1792,                        /* -std=c90 */
  OPT_std_c99 = 1793,                        /* -std=c99 */
  /* OPT_std_c9x = 1794, */                  /* -std=c9x */
  OPT_std_f2003 = 1795,                      /* -std=f2003 */
  OPT_std_f2008 = 1796,                      /* -std=f2008 */
  OPT_std_f2008ts = 1797,                    /* -std=f2008ts */
  OPT_std_f2018 = 1798,                      /* -std=f2018 */
  OPT_std_f95 = 1799,                        /* -std=f95 */
  OPT_std_gnu = 1800,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1801, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1802, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1803,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1804,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1805,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1806, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1807, */              /* -std=gnu++1z */
  /* OPT_std_gnu__20 = 1808, */              /* -std=gnu++20 */
  ...
  OPT_time = 1831,                           /* -time */
  OPT_time_ = 1832,                          /* -time= */
  OPT_tno_android_cc = 1833,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1834,                 /* -tno-android-ld */
